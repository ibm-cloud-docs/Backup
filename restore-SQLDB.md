...
15. To specify an alternate location for database files, select Alternate Path. Click the folder. In the Select Folder dialog box, select the alternate file location, and click Okay.

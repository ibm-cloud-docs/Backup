...
17. Click Run Restore. The Process Details dialog box shows the restore progress and indicates when the restore is completed. Other recent job processes might also be listed in the dialog box. To close the Process Details dialog box, click Close. Closing the window does not affect the restore process.

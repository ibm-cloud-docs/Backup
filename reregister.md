...
# Reregistering {{site.data.keyword.backup_notm}} vault
{: #reregister}
{: help}
{: support}

Reregister your {{site.data.keyword.backup_notm}} vault after OS reloads or to restore data from one server to another using existing backup data.
{: shortdesc}

...
# Installing {{site.data.keyword.backup_notm}} client in Windows
{: #InstallinWindows}

Install the {{site.data.keyword.backup_notm}} client on Windows servers to enable automated backups with support for BMR and SQL Server protection.
{: shortdesc}

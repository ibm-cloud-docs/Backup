...
1. Locate the task that you want to delete from the vault. Click the minus icon ![subtract icon](../icons/subtract-alt.svg "Minus sign") to remove the data from the vault. 

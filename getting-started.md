...
3. Click **Storage** > **Cloud Backup** to display the backup services. In the list of all backup service instances, you see the following information.
   ...
   | Field         | Description |
   |---------------|-------------|
   | Instance name | The autogenerated name of the vault that you provisioned. It is also the username in the Backup Portal |
...
4. Click the instance name to display the details of the backup instance, including your portal username and password.
5. Click **Backup portal login** to start the portal in your browser, then enter your username and password when prompted.
